export default {
  ...
  update: {
    ...
    restartNow: '立即重启',
    applying: '应用中...',
    pendingReady: '更新包已就绪，请确认后应用或取消',
    pendingKind: '类型',
    pendingKindMeta: 'Meta 包',
    pendingKindLegacy: 'Legacy 脚本',
    pendingVersion: '待应用版本',
    confirmApply: '确认应用待更新？可选择是否立即重启设备。',
    applySuccess: '更新已应用',
    applySuccessReboot: '更新已应用，设备正在重启...',
    confirmCancelUpdate: '确认取消待应用更新？将清理暂存包，不影响当前运行固件。',
    cancelSuccess: '已取消待应用更新',
    cancelFailed: '取消更新失败',
    applyFailed: '应用更新失败',
    statusFailed: '获取更新状态失败',
    currentVersion: '当前版本',
    checkUpdate: '检查更新',
    checking: '检查中...',
    noUpdate: '已是最新版本',
